...
valueBox(value = paste(sum(df$confirmed), "Cases", sep = " "), caption = "Confirmed Cases", icon = "fas fa-ambulance", color = "#1f77b4")
```
...
This application provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic. This dashboard is built with R using the Rmakrdown framework and can easily reproduce by others.
