...
valueBox(value = sum(df$confirmed), caption = "Confirmed Cases", icon = "fas fa-ambulance", color = "#1f77b4")
```

### recovered {.value-box}

```{r}
valueBox(value = sum(df$recovered, na.rm = TRUE), caption = "Recovered Cases", icon = "fas fa-heartbeat", color = "green")
```
...
valueBox(value = sum(df$death, na.rm = TRUE), 
         caption = "Death Cases", 
