...
daily_confirmed %>%
  plotly::plot_ly() %>% 
  plotly::add_lines(x = ~ date, y = ~ China, name = "China") %>%
  plotly::add_lines(x = ~ date, y = ~ `Rest of the World`, name = "Rest of the World") %>%
...
coronavirus::coronavirus %>% 
  ...
  plotly::plot_ly(y = ~ round(100 * recover_rate, 1),
                  ...
                  # marker = list(size = ~ log(confirmed) , opacity = 0.5),
                  hoverinfo = 'text',
