---
title: "Coronavirus: the case of Belgium"
output: 
...
valueBox(value = paste(format(sum(df$unrecovered, na.rm = TRUE), big.mark = ","), " (",
                       ...
                       "%)", sep = ""), 
         caption = "Active cases (% of total)", icon = "fas fa-ambulance", 
         color = active_color)
```
...
valueBox(value = paste(format(sum(df$recovered, na.rm = TRUE), big.mark = ","), " (",
                       ...
                       "%)", sep = ""), 
         caption = "Recovered cases (recovery rate)", icon = "fas fa-heartbeat", 
...
### Daily cumulative cases by type, in **Belgium** only
...
plotly::plot_ly(data = df_daily) %>%
  ...
  plotly::add_annotations(x = as.Date("2020-02-04"),
                          y = 1,
                          ...
                          ax = -10,
                          ay = -90) %>%
  plotly::add_annotations(x = as.Date("2020-03-11"),
                          y = 3,
                          ...
                          ax = -90,
                          ay = -90) %>%
   plotly::add_annotations(x = as.Date("2020-03-18"),
                          y = 14,
                          text = paste("New containment",
                                       "<br>",
                                       "measures"),
                          xref = "x",
                          yref = "y",
...
### World map of cases (*+ and - to zoom in/out*)
...
For any question or feedback, you can [contact me](https://www.statsandr.com/contact/). More information about this dashboard can be found in this [article](https://www.statsandr.com/blog/).
